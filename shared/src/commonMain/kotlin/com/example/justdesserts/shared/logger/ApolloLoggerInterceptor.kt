...
@ApolloExperimental
class ApolloLoggerInterceptor(private val customLog: CustomLog) : ApolloRequestInterceptor {
    @ExperimentalTime
    override fun <D : Operation.Data> intercept(
        ...
        val timeStamp = elapsed.toIsoString()
        ...
        props["Response Time"] = timeStamp
        props["Response Time in Millis"] = timeInMillis
        val propsString = props.toString()
        customLog.customLogMessage(propsString)
        return response
    }
}
